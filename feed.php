            ...
            while($row = mysqli_fetch_assoc($result)){?>
                <div class="photo">
                    ...
                    <div class="photo__info">
                        ...
                        <span class="photo__likes"><?php echo $row['like'] ?>  likes</span>
                        <div class="photo__caption"><?php echo $row['caption'] ?></div><br>
                        <ul class="photo__comments">
                            <li class="photo__comment">
                                <span class="photo__comment-author">wardahnfh</span> love this!
                            </li>
                            <li class="photo__comment">
                                <span class="photo__comment-author">arleene</span> love this!
                            </li>
                            <li class="photo__comment">
                                <span class="photo__comment-author">reetouze</span> love this!
                            </li>
                            <li class="photo__comment">
                                <span class="photo__comment-author">ramom.angja</span> love this!
                            </li>
                        </ul>
